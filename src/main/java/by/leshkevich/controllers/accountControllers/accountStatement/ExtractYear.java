 ...
 * @version 1.0
 */
@WebServlet(name = "ExtractYear", value = AppConstant.EXTRACT_YEAR_CONTROLLER)
public class ExtractYear extends AbstractExtractYearController {
    /**
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            LocalDateTime dateTimeFor = LocalDateTime.now().minusYears(1);
            ...
            String statementAccountName = "accountStatement-" + dateManager.dateFormat() + "-" + number +"-year"+ ".pdf";
